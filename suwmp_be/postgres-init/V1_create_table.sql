...
INSERT INTO waste_types (id,
                         name,
                         description,
                         created_at,
                         updated_at,
                         deleted_at)
VALUES (1, 'ORGANIC', 'Biodegradable waste such as food scraps and garden waste', NOW(), NOW(), NULL),
       (2, 'RECYCLABLE', 'Waste materials that can be recycled such as plastic, paper, and metal', NOW(), NOW(), NULL),
       (3, 'HAZARDOUS', 'Waste that poses a risk to health or the environment, including chemicals and batteries',
        NOW(), NOW(), NULL);

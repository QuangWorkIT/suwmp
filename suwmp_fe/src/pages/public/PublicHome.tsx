  ...
  const mockHowItWorks = [
    {
      ...
      description:
        "Upload photos and easily classify your waste automatically with AI-powered mapping.",
      icon: Upload,
    },
    {
      title: "Efficient Collection",
      description:
        "Real-time tracking and optimized routes for faster, greener waste collection.",
      icon: Truck,
    },
    {
      title: "Earn Rewards",
      description:
        "Get points for proper recycling and climb the community leaderboard.",
      icon: Trophy,
    },
    {
      title: "Track Impact",
      description:
        "See your environmental impact with detailed analytics and reports.",
      icon: BarChart3,
    },
  ];
          ...
          >
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-4 text-lg text-muted-foreground">
                A seamless experience from waste reporting to collection and
                recycling
              </p>
            </div>
          ...
          <Card className="border-0 shadow-lg">
            <CardHeader className="text-center">
              ...
              <CardDescription className="mt-4 text-base">
                Join our growing community of eco-conscious citizens and help
                build a sustainable future for your neighborhood.
              </CardDescription>
            </CardHeader>

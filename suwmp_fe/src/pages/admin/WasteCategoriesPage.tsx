    ...
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      {!loading && !error && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Add custom type */}
          <button className="flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-purple-300 bg-white p-6 text-purple-600 hover:bg-purple-50 transition">
            <Plus size={32} />

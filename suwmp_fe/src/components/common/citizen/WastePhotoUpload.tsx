...
function WastePhotoUpload({ imageUploaded, setImageUploaded, handleNextStep }: WastePhotoUploadProps) {
  ...
  return (
    <Card className="p-8 animate-fade-up w-full shadow-lg">
      ...
      <div
        className={`border-2 border-dashed rounded-2xl p-10 text-center transition-all cursor-pointer hover:border-primary/50 hover:bg-primary/5 
      ...
      >
        {imageUploaded ? (
          <div className="space-y-5">
            ...
            <div className="w-150 h-76 mx-auto rounded-xl overflow-hidden border bg-muted">
              <img
      ...
      {error && (
        <p className=" text-destructive italic mt-2 text-center">{error}</p>
      )}

      <div className="flex justify-end mt-8">
        <Button
          onClick={handleNextStep}
          disabled={!imageUploaded} data-testid="button-next">
          Next Step
